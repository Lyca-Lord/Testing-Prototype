...
namespace Unit
{
    public partial class Units : MonoBehaviour
    {
        ...
        public void SetUp(MapCell _cell, string _unitName, bool _isPlayer = false, bool _isLocked = false)
        {
...
namespace Unit
{
    ...
    public class TacticState : UnitState
    {
        ...
        public override void Enter(Vector2 _position)
        {
            ...
            movePoint = isBonusMove ? (int)_position.y : unit.unitElement.currentTacticSpeed;
...
namespace Unit
{
    public partial class Units
    {
        ...
        public SpriteRenderer cardSelectIndicator;

        public void ChangeSortingOverlay(int _order)
        {
            sr.sortingOrder = _order;
            foreach (var icon in icons) icon.sortingOrder = _order + 1;
            foreach (var tmp in tmps) tmp.sortingOrder = _order + 1;
            square.sortingOrder = cardSelectIndicator.sortingOrder = _order - 1;
            pickIndicator.sortingOrder = _order + 1;

            pickIndicator.enabled = false;
            cardSelectIndicator.enabled = false;
        ...
        public void CloseCardSelectIndicator() => cardSelectIndicator.enabled = false;

        public void OpenCardSelectIndicator() => cardSelectIndicator.enabled = true;
