...
namespace Map
{
    ...
    {
        [Header("Sprite")]
        public List<Sprite> oddSprite;
        public List<Sprite> evenSprite;
    ...
    public partial class MapCell
    {
        public void Initialize(int _index, Vector2 _position, Vector2 _location, int _type)
        {
            location = _location;
            ...
            sr.sprite = ((index + _location.x) % 2 == 0) ? evenSprite[type] : oddSprite[type];
